...
export function AppNav({
  ...
  return (
    // The bar spans the window; its contents line up with the capped, centred
    // panels below it.
    <header className="shrink-0 border-b border-border bg-surface">
      <div className="mx-auto flex h-14 w-full max-w-[1700px] items-center gap-2 px-3 sm:gap-3 sm:px-4">
        <Link
          href="/"
